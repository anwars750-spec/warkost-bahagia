create unique index if not exists payment_webhook_events_provider_reference_uidx
on public.payment_webhook_events(provider, provider_reference)
where provider_reference is not null;

create unique index if not exists payment_webhook_events_provider_transaction_uidx
